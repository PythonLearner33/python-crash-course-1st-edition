...
def check_events(ai_settings, screen, sb, stats, play_button, ship, aliens, bullets):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            with open(r'C:\Users\Alvin\Desktop\desktop\python_work\Projects\alien_invasion\14.4.needtodo.py\highscore.txt', 'w') as highscore:
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    if len(aliens) == 0:
        ...
        # start a new level, and create new fleet.
        bullets.empty()
